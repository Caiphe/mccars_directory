<?php
  ...
  include('includes/header.php');
   ...
   $getCars = $db->query('SELECT * FROM car_data WHERE area="Durban" ORDER BY car_id DESC');
...
<style type="text/css">
	...
	#mini_search_form select option
	{
		font-size: 13px;
		margin-top: 3px;
		padding: 5px 10px;
	...
	#mini_search_form select option:after
	{
		padding: 5px 10px;
	}
	#mini_search_form select option:hover
	{
       color: red;
	}
	/*select_div option
...
<body>
	<div class="container-fluid" id="after_menu">
		<br>
		<span style="" class="all_new_cars_title">Over <?= $carCount; ?> Cars from Durban listed </span><br>
